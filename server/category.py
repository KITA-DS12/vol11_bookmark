...
def make_folder_category_list(book_mark_info_list, candidate_labels_list, other_folder_name='その他', category_score=0.5):
    ...
    def make_id_txt_category_list(book_mark_info_list):
        ...
        id_txt_category_list = [make_id_txt_category(
            v) for v in book_mark_info_list]
    ...
    def update_foldername(id_foldername, candidate_labels_list, other_folder_name, category_score):
        ...
        model_value = classifier(sequence_to_classify,
                                 candidate_labels, multi_label=False)
...
if __name__ == "__main__":
    print(make_folder_category_list(book_mark_info_list,
          candidate_labels_list, other_folder_name, category_score))
